...
from ace.database import db
from ace.add_user_to_db import add_user_to_database
from ace.send_file import send_media_and_reply
from ace.helpers import b64_to_str, str_to_b64
from ace.check_user_status import handle_user_status
from ace.force_sub_handler import (
    handle_force_sub,
    get_invite_link
)
from ace.broadcast_handlers import main_broadcast_handler
from ace.save_media import (
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/knoxbotsgroup)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=ace_{str_to_b64(file_er_id)}"
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes ",
                                             url="https://github.com/aceknox/FileStorebot")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/knoxbotsgroup).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/knoxbotsgroup).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
